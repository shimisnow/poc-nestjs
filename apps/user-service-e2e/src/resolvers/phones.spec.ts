...
describe('Phones Resolver', () => {
  ...
  describe('data request (role: user)', () => {
    test('exists', async () => {
      ...
      expect(result).toHaveProperty('data.phone.number');
      expect(Object.keys(result.data.phone).length).toBe(1);
      expect(result.data.phone.number).toBe(998765432);
    });
    ...
    test('exists (nested query)', async () => {
      ...
      expect(result).toHaveProperty('data');
      expect(result).toHaveProperty('data.phone.number');
      expect(result).toHaveProperty('data.phone.user');
      expect(result).toHaveProperty('data.phone.user.name');
      expect(result.data.phone.number).toBe(998765432);
      expect(result.data.phone.user.name).toBe('Shimi');
    });
